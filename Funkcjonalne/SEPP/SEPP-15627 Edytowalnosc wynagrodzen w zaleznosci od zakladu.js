...
describe('SEPP-15627 Edytowalność wynagrodzeń w zależności od zakładu', () => {
    ...
    it('Edytowalność wynagrodzeń w zależności od zakładu', () => {
        ...
        e23.rodzajKosztuPoz1Przycisk('010 Prace literackie').should('not.exist')
       

        cy.log('Krok 5 - rozwijam grupę "030 Prace reżysersko-realizacyjne"')
        e23.rodzajKosztuPoz1Przycisk('030 Prace reżysersko-realizacyjne').click()
        ...
        e23.rodzajKosztuPoz1Przycisk('070 Prace techniczne i pomocnicze').click()
