...
describe('SEPP-16931 Obieg akceptacji kosztorysu - CUP', () => {
    
    const porozumienieDane = {
        agencja: 'CUP',
        koordynatorUslug: 'test_user_18',
        producent: 'test_user_33',
        cel: '[U] Kosztorys usługowy (jednostki usługowej)',
        audycjaTV: 'SEPP-16931 Audycja Testowa - CUP',
        modelProdukcji: 'W - Wewnętrzny',
        rodzajPrzychodu: 'PW - Przychody wewnętrzne',
        rodzajUslugi: 'UR - Usługa realizacyjna',
        rodzajPorozumienia: 'kosztorys usług własnych CUP',
        pozycjaEdycji: {
            'Montażysta': {
                nazwa: 'Montażysta',
                JednostkaTVPSA: 'Jedn.Koszt.TVP',
    ...
    it('Obieg akceptacji kosztorysu - Koordynator usług', () => {
        ...
        e10.nazwaUzytkownika().should('contain',porozumienieDane.koordynatorUslug)
        ...
        e20.dodajPorozumienieCUP(porozumienieDane)
        ...
        // Aktywny kafelek 'Koordynator usług (Producent)' wyświetla się na czerwono z etykietą 'Wprowadzony'.
        ...
        cy.log('Krok 9 - Koordynator Usług przekazuje KU')
        e23.koordynatorUslugEtykieta().children('div').last().should('have.css', 'background-color', 'rgb(242, 222, 222)')
        e23.koordynatorUslugEtykieta().should('contain', 'Wprowadzony')
        ...
        e23.przekazKoordynatorUslugPrzycisk().click()
        ...
        fWspolne.sprawdzProgressBar()
        e23.koordynatorUslugEtykieta().should('contain', 'Przekazany do KKW')
        ...
        cy.get('[title="Jednostka TVP S.A."]>option').each(($ele) => {
            expect($ele).to.not.contain.text('Jedn.Koszt.TVP')
        })
    ...
    it('Obieg akceptacji kosztorysu - KKW', () => {            
        ...
        e23.edytujKosztPrzycisk('Asystent montażysty').click()
        cy.get('[title="Jednostka TVP S.A."]>option').eq(1).should('contain.text', 'Jedn.Koszt.TVP')
        e23.anulujZmianePrzycisk().click()
        e23.rodzajKosztuPrzycisk('Prace reżysersko-realizacyjne').click()
    ...
    it('Obieg akceptacji kosztorysu - Dyrektor Agencji CUP', () => {
        cy.log('Krok 29 - Zalogowanie Dyrektora Agencji CUP, przejście ekran "Porozumienia" i wyszukanie porozumienia')
        cy.visit('/')
        ...
        e23.akceptujDyrekcjaJUPrzycisk().scrollIntoView().click()
