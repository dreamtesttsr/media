...
describe('SEPP-14703 Wyszukiwanie wniosków o zasoby dla Dyrektora Agencji', () => {
    ...
    it('Wyszukiwanie wniosków o zasoby dla Dyrektora Agencji', () => {
        ...
        cy.log('Krok 5 - Wybieram "Inny (nieujęty w cenniku CUP) TPTZ" dla listy wyboru sprzętu')
        e501.sprzetLista().select('inny (nieujęty w cenniku CUP) TPTZ', {force: true})

        cy.log('Krok 6 - Klikam przycisk wyszukaj')
        e501.wyszukajPrzycisk().click()
        fWspolne.sprawdzProgressBar()
        e501.wnioskiTabela().get('tbody > tr').should('have.length.above', 1)
