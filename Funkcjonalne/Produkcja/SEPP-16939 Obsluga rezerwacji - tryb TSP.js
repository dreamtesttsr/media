...
describe('SEPP-16939 Obsługa rezerwacji - tryb TSP', () => {
    ...
    it('Dodanie rezerwacji dla audycji z porozumienia w trybie TSP', () => {   
        ...
        e501.nazwaAudycjiTVPoleTekstowe().type('SEPP-16939')
    ...
    it('Akceptacja rezerwacji przez Dyspozyturę', () => {   
        ...
        cy.log('Krok 6 - Jestem na ekranie listy wniosków o zasoby i przechodzę na ekran szczegółów rezerwacji przekazanej do dyspozytury dla audycji z porozumienia w trybie TSP')
        cy.goToMenu('Wnioski o przydzielenie zasobów')
        fWspolne.sprawdzProgressBar()
        e501.nazwaAudycjiTVPoleTekstowe().type('SEPP-16939')
