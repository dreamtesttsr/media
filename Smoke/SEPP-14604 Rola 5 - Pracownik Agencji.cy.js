...
describe('SEPP-14604 Rola 5', () => {
    ...
    it('Rola 5 - Pracownik Agencji', () => {
        ...
        cy.log('Krok 4 - Jestem na ekranie na ekranie masowej ewidencji sprzedaży i sprawdzam poprawność pól')
        ...
        cy.log('Krok 9 - Przechodzę na ekran Delegacja krajowa i sprawdzam poprawność pól')
        ...
        cy.log('Krok 10 - Przechodzę na ekran Delegacja zagraniczna i sprawdzam poprawność pól')
        e40.dodajDelegacjePrzycisk().click()
        ...
        cy.log('Krok 11 - Jestem na ekranie Faktury i sprawdzam poprawność pól')
        cy.goToMenu('Faktury')
        e35.sprawdzWidok()
        e35.sprawdzWidok5()
        e35.sprawdzFiltryZaawansowane()

        cy.log('Krok 12 - Jestem na ekranie szczegółów Faktury i sprawdzam poprawność pól')
        e35.edycjaPierwszyPrzycisk().click()
        e37.sprawdzWidok()
        e37.sprawdzWidok5()

        cy.log('Krok 13 - Jestem na ekranie Rachunki Wewnętrzne i sprawdzam poprawność pól')
        cy.goToMenu('Rachunki wewnętrzne')
        e38.sprawdzWidok()
        e38.sprawdzWidok5()
        e38.sprawdzFiltryZaawansowane()
        
        cy.log('Krok 14 - Jestem na ekranie Raport sprzedaży audycji i sprawdzam poprawność pól')
        cy.goToMenu('Raport sprzedaży audycji')
        e806.sprawdzWidok()
        e806.sprawdzWidok5()
        e806.sprawdzFiltryZaawansowane()

        cy.log('Krok 15 - Jestem na ekranie Rozliczenie kosztów zasobow i sprawdzam poprawność pól')
        cy.goToMenu('Rozliczenie kosztów zasobów')
        e808.sprawdzWidok()

        cy.log('Krok 16 - Jestem na ekranie Zamówienia i rozliczenia porozumienia i sprawdzam poprawność pól')
        cy.goToMenu('Zamówienia i rozliczenia porozumienia')
        e809.sprawdzWidok()
        e809.sprawdzFiltryZaawansowane()

        cy.log('Krok 17 - Jestem na ekranie Administracja -> Twórcy i sprawdzam poprawność pól')
        cy.goToMenu('Twórcy')
        e75.sprawdzWidok()
        ...
        cy.log('Krok 19 - Jestem na ekranie Administracja -> Rodzaj statusu i sprawdzam poprawność pól')
        cy.goToMenu('Rodzaj statusu')
        e72.sprawdzWidok()

        cy.log('Krok 20 - Jestem na ekranie Administracja -> Słowniki i sprawdzam poprawność pól')
        cy.goToMenu('Słowniki')
        e73.sprawdzWidok()

        cy.log('Krok 21 - Jestem na ekranie Administracja -> VAT w kosztach % i sprawdzam poprawność pól')
