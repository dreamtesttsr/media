...
describe('SEPP-14605 Rola 11', () => {
    ...
    it('Rola 11 - Kierownik Produkcji', () => {
        ...
        e20.edycjaPierwszyPrzycisk().click({force:true}) // błąd bez force true - element zasłania sam siebie?
        e22.sprawdzURL()
        ...
        cy.log('Krok 7 - Jestem na ekranie listy zamówień i sprawdzam poprawność pól')
        ...
        cy.log('Krok 8 - Jestem na ekranie Zamówienia na usługę i sprawdzam poprawność pól')
        ...
        cy.log('Krok 9 - Jestem na ekranie Zamówienia wewnętrznego i sprawdzam poprawność pól')
        e30.zaawansowanePrzycisk().click()
        ...
        cy.log('Krok 10 - Jestem na ekranie listy delegacji i sprawdzam poprawność pól')
        ...
        cy.log('Krok 11 - Jestem na ekranie Delegacji krajowej i sprawdzam poprawność pól')
        ...
        cy.log('Krok 12 - Jestem na ekranie Delegacji zagranicznej i sprawdzam poprawność pól')
        e40.dodajDelegacjePrzycisk().click()
        e40.zagranicznaPopupPrzycisk().click()
        e44.sprawdzWidok()
        e44.sprawdzWidokKosztyDelegacji()

        cy.log('Krok 13 - Jestem na ekranie Faktury')
        cy.goToMenu('Faktury')
        e35.sprawdzURL()
        e35.sprawdzWidok()
        e35.sprawdzWidok11()
        ...
        cy.log('Krok 14 - Jestem na ekranie dodawania Faktury')
        ...
        cy.log('Krok 15 - Jestem na ekranie listy Rachunków Wewnętrznych')
        ...
        cy.log('Krok 16 - Jestem na ekranie listy Wniosków o zasoby i sprawdzam poprawność pól')
        cy.goToMenu('Wnioski o przydzielenie zasobów')
        e501.sprawdzWidok()
        e501.sprawdzWidok11()
        e501.sprawdzFiltryZaawansowane()

        cy.log('Krok 17 - Wchodzę na ekran szczegółów Wniosku o zasoby w trybie podglądu i sprawdzam poprawność pól')
        ...
        cy.log('Krok 18 - Wchodzę na ekran szczegółów Wniosku o zasoby w trybie edycji i sprawdzam poprawność pól')
        e502.powrotPrzycisk().click()
        e501.edytujWniosekPierwszyPrzycisk().click({force: true})
        e502.sprawdzWidok()
        e502.sprawdzWidokEdycja11()        
     
        cy.log('Krok 19 - Jestem na ekranie listy Zamówień zewnętrznych i sprawdzam poprawność pól')
        cy.goToMenu('Zamówienia zewnętrzne')
        e516.sprawdzWidok()
        e516.sprawdzWidok11()
        e516.sprawdzFiltryZaawansowane()

        cy.log('Krok 20 - Jestem na ekranie Planowania produkcji i sprawdzam poprawność pól')
        cy.goToMenu('Planowanie produkcji')
        e503.sprawdzWidok()
        e503.sprawdzFiltryZaawansowane()
    
        cy.log('Krok 21 - Jestem na ekranie listy Zleceń pracy zasobu i sprawdzam poprawność pól')
        cy.goToMenu('Zlecenia pracy')
        e504.sprawdzWidok()
        e504.sprawdzWidok11()
        e504.sprawdzFiltryZaawansowane()

        cy.log('Krok 22 - Jestem na ekranie Karty pracy i sprawdzam poprawność pól')
        cy.goToMenu('Karty pracy')
        e509.sprawdzWidok()
        e509.sprawdzFiltryZaawansowane()

        cy.log('Krok 23 - Jestem na ekranie Czasu pracy środków technicznych i sprawdzam poprawność pól')
        cy.goToMenu('Czas pracy środków technicznych')
        e550.sprawdzWidok()

        cy.log('Krok 24 - Jestem na ekranie Kosztu pracy środków technicznych i sprawdzam poprawność pól')
        cy.goToMenu('Koszt pracy środków technicznych')
        e553.sprawdzWidok()

        cy.log('Krok 25 - Jestem na ekranie Cennika usług i sprzętu i sprawdzam poprawność pól')
        ...
        cy.log('Krok 27 - Jestem na ekranie Miejsca realizacji i sprawdzam poprawność pól')
        cy.goToMenu('Miejsca realizacji')
        e512.sprawdzWidok()

        cy.log('Krok 28 - Jestem na ekranie Raporty -> Rozliczenie kosztów zasobów i sprawdzam poprawność pól')
