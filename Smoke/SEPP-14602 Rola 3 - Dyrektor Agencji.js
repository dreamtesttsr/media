...
describe('SEPP-14602 Rola 3', () => {
    ...
    it('Rola 3 - Dyrektor Agencji', () => {
        ...
        cy.log('Krok 23 - Jestem na ekranie Raport sprzedaży audycji i sprawdzam poprawność pól')
        cy.goToMenu('Raport sprzedaży audycji')
        e806.sprawdzWidok()
        e806.sprawdzFiltryZaawansowane()

        cy.log('Krok 24 - Jestem na ekranie Rozliczenie kosztów zasobow i sprawdzam poprawność pól')
        cy.goToMenu('Rozliczenie kosztów zasobów')
        e808.sprawdzWidok()

        cy.log('Krok 25 - Jestem na ekranie Zamówienia i rozliczenia porozumienia i sprawdzam poprawność pól')
        ...
        cy.log('Krok 31 - Jestem na ekranie Stanowiska i sprawdzam poprawność pól')
