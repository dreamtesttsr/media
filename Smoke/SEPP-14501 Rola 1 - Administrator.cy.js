...
describe('SEPP-14501 Rola 1', () => {
    ...
    it('Rola 1 - Administrator', () => {
        ...
        cy.log('Krok 13 - Jestem na ekranie szczegółów zamówienia zewnętrznego i sprawdzam poprawność pól')
        e516.edycjaPierwszyPrzycisk().click()
        fWspolne.sprawdzProgressBar()
        e51601.sprawdzWidok()
        e51601.sprawdzWidok1()

        cy.log('Krok 14 - Jestem na ekranie Planowanie produkcji i sprawdzam poprawność pól')
        cy.goToMenu('Planowanie produkcji')
        e503.sprawdzWidok()
        e503.sprawdzFiltryZaawansowane()

        cy.log('Krok 15 - Jestem na ekranie Zlecenia pracy i sprawdzam poprawność pól')
        ...
        cy.log('Krok 16 - Jestem na ekranie Grafiki i sprawdzam poprawność pól')
        cy.goToMenu('Grafiki')
        e505.sprawdzWidok()
        ...
        cy.log('Krok 17 - Jestem na ekranie Karty pracy i sprawdzam poprawność pól')
        ...
        cy.log('Krok 18 - Jestem na ekranie Czas pracy środków technicznych i sprawdzam poprawność pól')
        cy.goToMenu('Czas pracy środków technicznych')
        e550.sprawdzWidok()

        cy.log('Krok 19 - Jestem na ekranie Koszt pracy środków technicznych i sprawdzam poprawność pól')
        cy.goToMenu('Koszt pracy środków technicznych')
        e553.sprawdzWidok()
        
        cy.log('Krok 20 - Jestem na ekranie Osoby przebywające na planie i sprawdzam poprawność pól')
        cy.goToMenu('Osoby przebywające na planie')
        e518.sprawdzWidok()

        cy.log('Krok 21 - Jestem na ekranie Dyżury i sprawdzam poprawność pól')
        cy.goToMenu('Dyżury')
        e515.sprawdzWidok()

        cy.log('Krok 22 - Jestem na ekranie Cennik i sprawdzam poprawność pól')
        cy.goToMenu('Cennik usług i sprzętu')
        e506.sprawdzWidok()

        cy.log('Krok 23 - Jestem na ekranie Miejsca realizacji i sprawdzam poprawność pól')
        cy.goToMenu('Miejsca realizacji')
        e512.sprawdzWidok()

        cy.log('Krok 24 - Jestem na ekranie Pracownicy produkcji i sprawdzam poprawność pól')
        cy.goToMenu('Pracownicy produkcji')
        e507.sprawdzWidok()

        cy.log('Krok 25 - Jestem na ekranie Słowniki -> Powody niedostępności zasobów i sprawdzam poprawność pól')
        cy.goToMenu('Powody niedostępności zasobów')
        e514.sprawdzWidok()
        e514.sprawdzWidok1()

        cy.log('Krok 26 - Jestem na ekranie Sprzęt i sprawdzam poprawność pól')
        cy.goToMenu('Sprzęt')
        e508.sprawdzWidok()

        cy.log('Krok 27 - Jestem na ekranie Grupy asortymentowe i sprawdzam poprawność pól')
        cy.goToMenu('Grupy asortymentowe')
        e517.sprawdzWidok()

        cy.log('Krok 28 - Jestem na ekranie Stanowiska i sprawdzam poprawność pól')
        ...
        cy.log('Krok 29 - Jestem na ekranie Rozliczenie kosztów zasobow i sprawdzam poprawność pól')
        cy.goToMenu('Rozliczenie kosztów zasobów')
        e808.sprawdzWidok()

        cy.log('Krok 30 - Jestem na ekranie Administracja -> Twórcy klikam naprzycisk dodaj twórce i sprawdzam poprawność pól')
        cy.goToMenu('Twórcy')
        e75.sprawdzWidok()
        
        cy.log('Krok 31 - Jestem na ekranie Administracja -> Użytkownicy i sprawdzam poprawność pól')
        cy.goToMenu('Użytkownicy')
        e78.sprawdzWidok()
        e78.sprawdzWidok1()

        cy.log('Krok 32 - Jestem na ekranie Administracja -> Dziennik zdarzeń i sprawdzam poprawność pól')
        cy.goToMenu('Dziennik zdarzeń')
        e71.sprawdzWidok()

        cy.log('Krok 33 - Jestem na ekranie Administracja -> Kontrahenci wciskam przycisk dodaj kontrahenta i sprawdzam poprawność pól')
        cy.goToMenu('Kontrahenci')
        e7601.sprawdzWidok()

        cy.log('Krok 34 - Jestem na ekranie Administracja -> VAT w kosztach % i sprawdzam poprawność pól')
        cy.goToMenu('VAT w kosztach %')
        e77.sprawdzWidok()

        cy.log('Krok 35 - Jestem na ekranie Administracja -> Rodzaj statusu i sprawdzam poprawność pól')
        ...
        cy.log('Krok 36 - Jestem na ekranie Administracja -> Słowniki i sprawdzam poprawność pól')
