...
describe('SEPP-14513 Rola 26', () => {
    ...
    it('Rola 26 - Kierownik Działu Organizacji Usług', () => {
        ...
        e516.numerZamowieniaPoleTekstowe().type('ZZ/1/2020') // docelowo ZZ/1234/2022
        ...
        cy.log('Krok 13 - Jestem na ekranie Słowniki -> Cennik usług i sprzętu i sprawdzam poprawność pól')
        cy.goToMenu('Cennik usług i sprzętu')
        e506.sprawdzWidok()

        cy.log('Krok 14 - Jestem na ekranie Słowniki -> Sprzęt i sprawdzam poprawność pól')
        cy.goToMenu('Sprzęt')
        e508.sprawdzWidok()

        cy.log('Krok 15 - Jestem na ekranie Słowniki -> Miejsca realizacji i sprawdzam poprawność pól')
        cy.goToMenu('Miejsca realizacji')
        e512.sprawdzWidok()

        cy.log('Krok 16 - Jestem na ekranie Raporty -> Rozliczenie kosztów zasobów i sprawdzam poprawność pól')
