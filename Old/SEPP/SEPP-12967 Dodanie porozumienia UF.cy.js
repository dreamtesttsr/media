...
describe('SEPP-12967 Dodanie porozumienia UF', function () {
    const dzisiaj = DateTime.now().toFormat('dd.MM.yyyy')
    const rndStr = faker.lorem.words(3)
    it('Dodanie porozumienia UF', function () {
        ...
        cy.get('#TvAudition').type('test uf: ' + rndStr)
        ...
        cy.wait(2000)
        cy.get('#select2-ServiceTypeId-container').should('have.attr', 'data-original-title', 'UF - Usługa filmowa').click()
