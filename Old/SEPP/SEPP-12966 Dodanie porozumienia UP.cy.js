...
describe('SEPP-12966 Dodanie porozumienia UP', function () {
    ...
    it('Dodanie porozumienia UP', function () {
        ...
        cy.get('#TvAudition').type('test up: ' + rndStr)
        ...
        cy.log('Krok 4 - zapisanie porozumienia i sprawdzenie poprawności danych')
        cy.get('#btnSubmitAgreement').click()
        // eslint-disable-next-line cypress/no-unnecessary-waiting
        cy.wait(2000)        
        cy.get('#select2-ServiceTypeId-container').should('have.attr', 'data-original-title', 'UP - Usługa produkcyjna').click()
        cy.get('#select2-ServiceTypeId-results', { timeout: 5000 }).should('be.visible')
        ...
        cy.log('Krok 5 - Weryfikacja możliwości zmiany rodzaju usługi')      
        e22.rodzajUslugiLista().select('UF - Usługa filmowa', {force: true})
