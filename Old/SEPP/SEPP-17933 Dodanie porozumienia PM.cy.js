...
describe('SEPP-17933 Dodanie porozumienia PM', function () {
    const dzisiaj = DateTime.now().toFormat('dd.MM.yyyy')
    const rndStr = faker.lorem.words(3)
    it('Dodanie porozumienia PM', function () {
        ...
        cy.get('#select2-IncomeTypeId-container').should('have.attr', 'data-original-title', 'PM - Przychody mieszane')
