...
describe('SEPP-12964 Dodanie porozumienia PW', function () {
    const dzisiaj = DateTime.now().toFormat('dd.MM.yyyy')
    const rndStr = faker.lorem.words(3)
    it('Dodanie porozumienia PW', function () {
        ...
        cy.get('#TvAudition').type('test pw: ' + rndStr)
        ...
        cy.get('#select2-IncomeTypeId-container').should('have.attr', 'data-original-title', 'PW - Przychody wewnętrzne')
