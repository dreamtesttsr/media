class E20{
    ...
    sprawdzFiltryZaawansowane(){
        ...
        this.rodzajProdukcjiLista().should('be.visible')
    ...
    sprawdzDodawaniePorozumieniaWidok(){
        this.nrPoleTekstowe().should('be.visible')
        this.nrWewnPoleTekstowe().should('be.visible')
        this.dataZawData().should('be.visible')
        this.audycjaTVPoleTekstowe().should('be.visible')
        this.jednZamLista().should('be.visible')
        this.agencjaLista().should('be.visible')
        this.jednWspLista().should('be.visible')
        this.redakcjaZamLista().should('be.visible')
        this.producentLista().should('be.visible')
        this.nadzorProdLista().should('be.visible')
        this.rodzajProdukcjiLista().should('be.visible')
        this.rodzPlatnLista().should('be.visible')
        this.trybProdukcjiLista().should('be.visible')
        this.porozumienieTrojstronnePrzyciskWyboru().should('be.visible')
        this.modelProdukcjiDodawanieLista().should('be.visible')
        this.fKinowyPrzyciskWyboru().should('be.visible')
        this.lokowaniePrzyciskWyboru().should('be.visible')
        this.wartoscFunduszuPoleTekstowe().should('be.visible')
        this.zgodaSPData().should('be.visible')
    ...
    dodajPorozumienie(porozumienieDane){
        ...
        this.rodzajProdukcjiLista().select(porozumienieDane.rodzajProdukcji, {force: true})
