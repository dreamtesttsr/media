class E24{
    ...
    zapiszEdycjaPrzycisk(){
        return cy.get('button#UpdateButton').contains('Zapisz')
    }
    ...
    zapiszIDodajNowaEdycjaPrzycisk(){
        return cy.get('button#UpdateWithAnotherButton').contains('Zapisz i dodaj nową')
    }
    ...
    cenaSprzedazyPoleTekstowe(){
        return cy.get('input#SellPriceEpisode')
    }
    ...
    cenaSprzedazyJWPoleTekstowe(){
        return cy.get('input#JwSellPriceEpisode')
    }
    ...
    sprawdzWidokDevelopment(){
        ...
        this.mpkPoleTekstowe().should('not.exist')
        ...
        this.cenaSprzedazyJWPoleTekstowe().should('be.visible')
    ...
    sprawdzWidokEvent(){
        ...
        this.kosztorysPoleTekstowe().should('be.visible')
        this.odcinekPoleTekstowe().should('be.visible')
        this.mpkPoleTekstowe().should('be.visible')
