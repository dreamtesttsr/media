class E50301 {
    ...
    bledyWalidacjiPopupEtykieta(){
        return cy.get('#ErrorListToConfirm > tbody')
    }

    potwierdzPopupPrzycisk(){
        return cy.get('button#modalConfirmationNewWorkOrder-yesBtn')
    }

    anulujPopupPrzycisk(){
        return cy.get('button#modalConfirmationNewWorkOrder-noBtn')
    }
