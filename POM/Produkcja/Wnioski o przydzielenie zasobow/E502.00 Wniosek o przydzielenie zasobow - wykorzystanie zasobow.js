...
class E50200 {
    ...
    zamowienieZewPierwszyPrzyciskWyboru(){
        return cy.get('input[data-original-title="Zamówienie zewnętrzne"]').first()
    }

    zamowienieZewPrzyciskWyboru(index){
        return cy.get('input[data-original-title="Zamówienie zewnętrzne"]').eq(index)
    }
